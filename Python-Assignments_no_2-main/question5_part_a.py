...
#______________________________sum of 100 random numbers b/w 10 - 90________________________________________

sum = 0
for i in random_number_list:
    sum = sum+i
print(f"Sum of 100 random numbers b/w (10-90): {sum}\n")